...
def _schema_path_for_receipt(root_dir: Path, receipt_schema: str) -> Optional[Path]:
    ...
    if receipt_schema == "ajax.receipt.efe_autogen.v0":
    ...
    if receipt_schema == "ajax.receipt.crystallization_seed.v1":
        return schemas_dir / "ajax.receipt.crystallization_seed.v1.schema.json"
